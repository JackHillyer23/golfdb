...
class EventDetector(nn.Module):
    def __init__(self, pretrain, width_mult, lstm_layers, lstm_hidden, bidirectional=True, dropout=True):
         # width_mult kept for API compatibility with original codebase but not actually used by torchvision
        ...
        with torch.no_grad():
            ...
            print(f'MobileNetV2 (torchvision) feature dim: {self.feature_dim}')
