...
class EventDetector(nn.Module):
    def __init__(self, pretrain, width_mult, lstm_layers, lstm_hidden, bidirectional=True, dropout=True):
        ...
        self.width_mult = width_mult # width_mult kept for API compatibility with original codebase but not actually used by torchvision
        self.lstm_layers = lstm_layers
        self.lstm_hidden = lstm_hidden
        self.bidirectional = bidirectional
        self.dropout = dropout

        #load MobileNetV3-Large backbone with pretrained weights
